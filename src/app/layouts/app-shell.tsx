...
export const AppShell = () => {
  return (
    <NotificationsRealtimeProvider>
      <ShellNavProvider>
        <div
          className="relative min-h-[var(--tg-viewport-height,100dvh)] overflow-x-hidden bg-base"
          style={{
        ...
        >
          ...
          <main className="relative mx-auto min-h-[var(--tg-viewport-height,100dvh)] w-full max-w-lg">
            <Outlet />
          </main>
          <BottomNav />
        </div>
