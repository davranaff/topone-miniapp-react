...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        shimmer:
          "linear-gradient(90deg, rgb(var(--bg-surface)) 25%, rgb(var(--bg-elevated)) 50%, rgb(var(--bg-surface)) 75%)",
        "gold-135":
          "linear-gradient(135deg, rgb(var(--accent-gold-strong)), rgb(var(--accent-gold)))",
        hero:
          "radial-gradient(circle at top, rgba(212,160,23,0.2), transparent 55%)",
      },
